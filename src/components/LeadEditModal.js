...
<Grid item  xs={4} md={4} sx={{overflowY:'scroll',maxHeight:'36vw',mt:4}}>

<LeadTimeline data={this.state.alldata.idl} />

</Grid>

<Grid item xs={8} md={8} sx={{Height:550}}>

<Paper sx={{padding:2,height:'auto'}}>

<Grid container>
<Grid item xs={5} md={5} sx={{backgroundColor:'#f0f0f0',height:'auto'}}>
...
<LeadFeedBack data={this.state.alldata.idl} callback={this.props.callback} status={this.props.status} tags={this.props.tags}  />
